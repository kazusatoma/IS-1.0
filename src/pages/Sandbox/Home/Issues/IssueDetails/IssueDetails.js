...
export default function IssueDetails() {
    ...
    const onCreate = (values) => {
        ...
        axios.patch(`http://localhost:5000/it_issue/${myData[0].id}`, {
            ...
            "identified_date": moment(values.identified_date),
            "related_project": values.related_project,
            "assigned_to": values.assigned_to,
            "status": values.status,
            "priority": values.priority,
            "target_resolution_date": moment(values.target_resolution_date),
            "progress": values.progress,
            "actual_resolution_date": moment(values.actual_resolution_date),
